...
class manager {
    ...
    Quiz(pergunta: "13 + 123", opcoes: ["136","132","145","-136"], respostaCorrect: 0),
    Quiz(pergunta: "19 + 23", opcoes: ["43","42","54","-42"], respostaCorrect: 1),
    Quiz(pergunta: "5/25", opcoes: ["0,2","-0,2","6","9"], respostaCorrect: 0),
    Quiz(pergunta: "32/2", opcoes: ["12","21","16!","16"], respostaCorrect: 3),
